...
public class SAConstants {
    ...
    public static final Map<String, String> apartmentTypeCodeMap = new HashMap<String, String>();

    public static final int EXCEPTION_TYPE_GENERIC = 1;
    public static final int EXCEPTION_TYPE_UNAUTHORIZED = 2;
    public static final int EXCEPTION_TYPE_BAD_REQUEST = 3;
    public static final int EXCEPTION_TYPE_CLIENT= 4;
    ...
    public static final String APARTMENT_ALREADY_ADDED = "You already have an apartment added with the name: ";
